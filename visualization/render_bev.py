#!/usr/bin/env python3
"""Bird's-eye (top-down) view of the ground truth against the tracker, from the dumps. Fast, no GPU.
Ego at the bottom, range rings, ground truth (filled circle + trail), tracker (square + trail)."""
