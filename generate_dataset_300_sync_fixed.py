#!/usr/bin/env python3
"""
Gerador de Dataset Grande CORRIGIDO - Com sincronização LiDAR-Câmera
"""
...
print("\n" + "="*70)
print("🚀 GERADOR DE DATASET COM SINCRONIZAÇÃO CORRIGIDA!")
print("="*70)
...
output_dir = Path("dataset_300_fusion_sync_fixed")
...
print(f"   • SINCRONIZAÇÃO: Pausar simulação durante captura")
...
for scenario_idx, scenario in enumerate(scenarios):
    ...
    # Aguarda estabilização dos drones
    time.sleep(3)
    ...
    for yaw_idx, yaw in enumerate(yaw_angles):
        ...
        time.sleep(1.0)  # Aumenta delay para garantir estabilização

        frame_name = f"frame_{total_frames:04d}"

        # ==== SINCRONIZAÇÃO CRÍTICA ====
        # Pausa a simulação para capturar dados sincronizados
        client.simPause(True)

        # Captura timestamp para verificar sincronização
        capture_time = time.time()

        # Captura imagem RGB e LiDAR SIMULTANEAMENTE
        ...
        if lidar_data and len(lidar_data.point_cloud) > 3 and img_bgr is not None:
            ...
            if total_frames % 10 == 0:
                ...
                print(f"      ✅ Sincronização: simPause ativado")
...
print("\n" + "="*70)
print("🎉 DATASET COMPLETO COM SINCRONIZAÇÃO CORRIGIDA!")
print("="*70)
print(f"\n📊 ESTATÍSTICAS FINAIS:")
...
print("\n✅ CORREÇÕES APLICADAS:")
print("   • ✅ SINCRONIZAÇÃO: simPause durante captura")
print("   • ✅ Captura simultânea de RGB e LiDAR")
print("   • ✅ Delay adequado após movimentos")
print("   • ✅ Timestamps para verificar sincronização")
print("\n🚁 Dataset pronto com sincronização perfeita!")