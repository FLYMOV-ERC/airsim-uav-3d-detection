#!/usr/bin/env python3
"""ARCHIVED. Step 5 of the segmentation-labeling chain: overlay preview.

The visual check used to judge the segmentation labels and conclude they were
unusable (Section 7.2.3, route (i)).
"""
...
def main():
    ...
    for cam in args.cameras:
        ...
        if not img_dir.exists():
            print(f"Skipping {cam}: image directory not found")
            continue
