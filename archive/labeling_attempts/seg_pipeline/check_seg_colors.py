#!/usr/bin/env python3
"""ARCHIVED. Check which stencil colours actually appear in the segmentation image.

This is the check that revealed the drones shared a colour with the background,
which is why route (i) of Section 7.2.3 was abandoned.
"""
