#!/usr/bin/env python3
"""ARCHIVED. Live box check, third iteration.

Writes several PLYs across many drone positions and ego yaw angles, to validate
the manually constructed box under rotation. The most thorough of the three.
"""
...
def main():
    ...
    # 6 scenarios: varying ego yaw, drone yaw, range and azimuth
    ...
    for ego_g, ego_yaw_deg, drone_g, drone_yaw_deg, label in SCENARIOS:
        ...
        # Manual box using the ACTUAL ego/drone yaw (read back after the sim step)
