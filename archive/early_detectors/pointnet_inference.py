#!/usr/bin/env python3
"""ARCHIVED. Inference wrapper for the PointNet++ Painted v4 model.

For each YOLO box: paint the full cloud with prob = confidence inside the box and
0 outside, resample to a fixed N=4096, normalise XYZ (centroid + scale), run the
forward pass, and denormalise the centre and size.

Superseded by detection/frustum/detector.py.
"""
