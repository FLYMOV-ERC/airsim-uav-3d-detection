"""ARCHIVED. Environmental variety for AirSim scenes.

Weather effects, time-of-day changes and lighting variation -- the domain
randomisation module. Imported only by archived scripts; the canonical collector
carries its own randomisation. Kept so the archived collector still runs.
"""
