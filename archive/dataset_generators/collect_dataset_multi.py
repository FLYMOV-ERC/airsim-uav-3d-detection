"""ARCHIVED. Enhanced dataset collection with several drones and varied scenarios.

Supports four or more drones with diverse movement patterns and environmental
conditions; the only importer of scene_variation.py. The documented
multi-scenario workflow (see archive/docs/). Superseded by the canonical
collector, dataset_generation/collect_airsim.py.
"""
...
from archive.dataset_generators.scene_variation import SceneVariation
