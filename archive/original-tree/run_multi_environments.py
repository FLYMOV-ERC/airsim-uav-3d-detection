...
Automation script to run dataset collection across multiple AirSim environments
Manages launching different environments and collecting varied datasets
"""
    ...
    def run_multi_environment_collection(self, environments: Dict[str, Dict],
        ...
        for env_name, env_config in environments.items():
            if not env_config.get('path'):
                print(f"\n⚠️ Skipping {env_name}: No path specified")
                continue
