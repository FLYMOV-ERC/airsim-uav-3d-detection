#!/usr/bin/env python3
"""Detector 3D via PointNet++ + frustum extraído de bbox YOLO (modelo treinado
em dataset_frustum_pn2 com YOLO@conf=0.10).

Pipeline:
  1. Crop frustum: pontos do PC dentro do bbox 2D
  2. Sample fixo N=4096 (com replacement se pouco)
